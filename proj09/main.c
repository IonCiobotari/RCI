...
#include "tcp_con.h"
#include "bestpops.h"
////////////////          ./iamroot abc:193.136.138.142:59000 -i 192.168.1.6 -b
////////////////          valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes -v ./iamroot abc:193.136.138.142:59000 -i 192.168.1.7
/*
    testar tudo
*/
